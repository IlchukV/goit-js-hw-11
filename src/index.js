...
// send the listener to the form and the button
refs.searchForm.addEventListener('submit', onSearchForm);
refs.loadBtn.addEventListener('click', onLoadMoreBtn)
// set the initial state of the loadbutton is "hidden"
...
function renderGallery(data) {
  ...
  try {
    ...
    // calls the smoothScroll function
    smoothScroll();
  } catch (error) {
    console.log(error);
  }
...
// create gallery cards based on input dynamic data
